...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children }) => {
    ...
    const modalContent = (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-8 overflow-y-auto">
            ...
            <div className="relative w-full max-w-2xl bg-white dark:bg-zinc-900 border-2 border-black dark:border-white shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] dark:shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] flex flex-col animate-scale-in">
                {/* Scanline Effect */}
